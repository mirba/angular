...
.ui-colorpicker-panel .ui-colorpicker-color {
     width: 150px;
     height: 150px;
     background: transparent url("#{$ux-assets-path}/images/plugins/primeNG/color.png") no-repeat left top;
}
...
.ui-colorpicker-panel .ui-colorpicker-hue {
    background: transparent url("#{$ux-assets-path}/images/plugins/primeNG/hue.png") no-repeat left top;
    width: 17px;
    height: 150px;
    top: 8px;
    left: 167px;
...
.ui-lightbox-loading .ui-lightbox-content {
    background: url("#{$ux-assets-path}/images/plugins/primeNG/loading.gif") #000000 center center no-repeat;
}
...
.ui-password-panel .ui-password-meter {
    height: 10px;
    background:transparent url("#{$ux-assets-path}/images/plugins/primeNG/password-meter.png") no-repeat left top;
    padding: 0;
    margin: 0;
}
...
.ui-tree.ui-tree-horizontal .ui-treenode {
    background: url("#{$ux-assets-path}/images/plugins/primeNG/line.gif") repeat-x scroll center center transparent;
    padding: .25em 2.5em;
}
...
.ui-tree.ui-tree-horizontal .ui-treenode-connector-line {
    background: url("#{$ux-assets-path}/images/plugins/primeNG/line.gif") repeat-y scroll 0 0 transparent;
    width: 1px;
}
