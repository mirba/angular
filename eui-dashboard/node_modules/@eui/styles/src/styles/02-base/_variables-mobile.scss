...
$lg: new-breakpoint(min-width map-get($ux-grid-breakpoints, 'lg')) !default;
...
$ux-bkp-desktop: new-breakpoint(min-width map-get($ux-grid-breakpoints, 'lg')) !default;
$ux-bkp-desktop-up: new-breakpoint(min-width map-get($ux-grid-breakpoints, 'lg')) !default;
$ux-bkp-desktop-wide: new-breakpoint(min-width map-get($ux-grid-breakpoints, 'lg')) !default;
