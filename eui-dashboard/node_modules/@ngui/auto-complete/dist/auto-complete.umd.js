(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@angular/core"), require("@angular/forms"), require("@angular/common/http"), require("rxjs/add/operator/map"), require("@angular/common"));
	else if(typeof define === 'function' && define.amd)
		define(["@angular/core", "@angular/forms", "@angular/common/http", "rxjs/add/operator/map", "@angular/common"], factory);
	else if(typeof exports === 'object')
		exports["auto-complete"] = factory(require("@angular/core"), require("@angular/forms"), require("@angular/common/http"), require("rxjs/add/operator/map"), require("@angular/common"));
	else
		root["auto-complete"] = factory(root["@angular/core"], root["@angular/forms"], root["@angular/common/http"], root["rxjs/add/operator/map"], root["@angular/common"]);
