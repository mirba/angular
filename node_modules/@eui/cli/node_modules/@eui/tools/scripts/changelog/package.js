 ...
 */
exports.getUserPackage = function (options) {

  options = options || {};

  var userPackagePath;

  if (options.packageRootPath) {
    userPackagePath = path.join(options.packageRootPath,'package.json');
  } else {
    userPackagePath = path.join(process.cwd(), 'package.json');
  }

  console.log('---userPackagePath : ', userPackagePath);
 ...
 */
exports.extractRepoUrl = function (options) {

  options = options || {};
  return exports.getUserPackage(options)
