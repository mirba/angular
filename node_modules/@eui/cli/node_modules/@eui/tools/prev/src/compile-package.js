...
const GLOBALS = {
    ...
    '@eui/ux-commons': 'eui-ux-commons',
    "@eui/ux-core": 'eui-ux-core',
    "extend": "extendProxy",
    'cleave.js': 'Cleave',
    'Cleave': 'Cleave',
    'angular2-moment': 'angular2Moment',
    'primeng/components/calendar/calendar': 'primeng_components_calendar_calendar',
    'moment': 'moment',
    'moment-timezone': 'momenttz',
    'lodash': 'lodash',
    'primeng/components/chart/chart': 'primeng_components_chart_chart',
    'ng2-dragula': 'ng2_dragula',
    'primeng/primeng': 'primeng_primeng',
    'primeng/components/autocomplete/autocomplete': 'primeng_components_autocomplete_autocomplete',
    'primeng/components/tree/tree': 'primeng_components_tree_tree',
    'primeng/components/datatable/datatable': 'primeng_components_datatable_datatable',
    "arrify": 'arrify'
};
...
function run(package, inputOpt) {
    ...
    return Promise.resolve()
        ...
        .then(() => {
            ...
            return Promise.resolve(ngcCompile(`${tempLibFolder}/tsconfig.json`))
